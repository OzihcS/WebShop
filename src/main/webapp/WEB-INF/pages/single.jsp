...
<html>
<head>
    <title>Super Market an Ecommerce Online Shopping Category Flat Bootstrap Responsive Website Template | Single Page
        :: w3layouts</title>
    <!-- for-mobile-apps -->
            ...
            <div class="col-md-8 agileinfo_single_right">
                ...
                <div class="snipcart-item block">
                    <div class="snipcart-thumb agileinfo_single_right_snipcart">
                        <h4 class="m-sing">Manufacturer: ${product.manufacturer}</h4>
                    </div>
                    <div class="snipcart-thumb agileinfo_single_right_snipcart">
                        <h4 class="m-sing">Price: ${product.price} $</h4>
                    </div>
