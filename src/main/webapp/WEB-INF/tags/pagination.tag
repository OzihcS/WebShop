                ...
                <c:otherwise>
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <li>
                                <a onclick='setPagination(${requestScope.currentPage-1})'>${requestScope.currentPage-1}<span
                                        class="sr-only"></span></a></li>
                        </c:otherwise>
                    </c:choose>


                    <li><a onclick='setPagination(${requestScope.currentPage})'>${requestScope.currentPage}<span
                            class="sr-only"></span></a></li>
                    ...
                    <c:choose>
                        <c:when test="${requestScope.currentPage + 2 == requestScope.pages}">
                            <li>
                                <a onclick='setPagination(${requestScope.currentPage+1})'>${requestScope.currentPage+1}<span
                                        class="sr-only"></span></a></li>
                            <li><a onclick='setPagination(${requestScope.pages})'>${requestScope.pages}<span
                                    class="sr-only"></span></a></li>
                        </c:when>
